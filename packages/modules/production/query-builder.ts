/**
 * ProductionQueryBuilder - Cross-module data access for Production
 * 
...
export class ProductionQueryBuilder implements ModuleQueryBuilder {
  ...
  private getTableName(): string {
    ...
    if (!tableName) {
      throw new Error(`Unknown entity: ${this.entityName}. Supported: production_orders, work_orders, bom, etc.`);
    }
