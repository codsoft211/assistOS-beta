...
import { Package, Search, Eye, Edit, FileText, MoreHorizontal } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function FinishedGoodsPage() {
  ...
  const finishedGoods = products.filter((p) => p.itemType === 'SALE');
    ...
    return (
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Products ready for sale</p>
        </div>
        <Card>
  ...
  return (
    <div className="p-6 space-y-6" data-testid="page-finished-goods">
      <div className="flex flex-row items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-page-title">
            <Package className="inline h-8 w-8 mr-2 text-green-600" />
            Finished Goods
          </h1>
          <p className="text-muted-foreground">
            {filteredProducts.length} products ready for sale. Costs derived from BOM/Recipe.
          </p>
